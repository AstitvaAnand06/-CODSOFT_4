...
BASE_DIR = r"F:\Coding\CODSOFT\CODSOFT\Spam_Sms_Detection"  # Replace with your actual file path
...
subtitle_label = ttk.Label(header_frame, text="Check if your message is spam or ham !?",
                           font=('Lucida Calligraphy', 22), foreground="Tomato")
...
message_label = ttk.Label(input_frame, text="Type your Message here: 👇", font=('Lucida Calligraphy', 20),
...
footer_label = ttk.Label(footer_frame, text="Powered by SVM Model (Accuracy: 97.9%)", font=('MV Boli', 15),
                         foreground="Sienna")
footer_label.pack()
